...
[![Tech Stack](https://skillicons.dev/icons?i=html,css,js,ts,py,php,react,nextjs,vite,tailwind,nodejs,express,laravel,mysql,postgres,supabase,github,postman&theme=dark&perline=9)](https://skillicons.dev)
